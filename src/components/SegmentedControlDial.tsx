...
const styles = StyleSheet.create({
  ...
  contextRow: { minHeight: 20, marginTop: space.md, paddingHorizontal: space.md, justifyContent: 'center', alignItems: 'center' }, contextRowQuiet: { minHeight: 28 }, contextLabel: { ...type.caption, color: colors.textSecondary, textAlign: 'center', lineHeight: 17 },
