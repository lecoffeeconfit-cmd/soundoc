...
const styles = StyleSheet.create({
  shell: { minHeight: 58, minWidth: 150, paddingHorizontal: 10, paddingVertical: 8, borderRadius: radius.large, backgroundColor: colors.surfaceElevated, borderWidth: 1, borderTopColor: 'rgba(255,255,255,0.12)', borderBottomColor: 'rgba(0,0,0,0.72)', flexDirection: 'row', alignItems: 'center', gap: space.xs, ...shadows.raised },
