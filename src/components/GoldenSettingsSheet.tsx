...
export function GoldenSettingsSheet({ visible, enabled, preferences, profile, activeItem, voices, onClose, onReset, onUndo }: Props) {
  ...
  const reset = () => Alert.alert('Reset Golden Listening?', 'This removes what Golden has learned and returns to Soundoc’s recommended settings. Your documents and other settings are unchanged.', [{ text: 'Cancel', style: 'cancel' }, { text: 'Reset', style: 'destructive', onPress: onReset }]);

  return <Modal visible={visible} animationType="slide" presentationStyle="pageSheet" onRequestClose={onClose}>
    <SafeAreaView style={styles.screen}>
      <View style={styles.header}><View style={styles.headerCopy}><Text style={styles.title}>Your Golden Profile</Text><Text style={styles.subtitle}>Golden learns the listening style you prefer while keeping Soundoc’s recommended settings as its foundation.</Text></View><Pressable onPress={onClose} accessibilityRole="button" accessibilityLabel="Close Golden Profile"><Text style={styles.done}>Done</Text></Pressable></View>
      {!enabled && <View style={styles.offNotice}><Text style={styles.noticeIcon}>✦</Text><Text style={styles.noticeText}>Golden is currently off. These are the settings it will use when enabled.</Text></View>}
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <Text style={styles.sectionLabel}>CURRENT GOLDEN SOUND</Text>
        ...
        <Text style={styles.sectionLabel}>WHAT GOLDEN HAS LEARNED</Text>
