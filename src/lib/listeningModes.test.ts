...
export function runListeningModeFixtures() {
  ...
  if (custom.rate !== 1.23 || custom.pitch !== 1.1 || custom.sentencePauseMs !== 111) throw new Error('custom profile was overwritten');
